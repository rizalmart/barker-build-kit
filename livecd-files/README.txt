...
bdrv=<partition>   Specifies the bdrv...sfs  partition
gdrv=<partition>   Specifies the gdrv...sfs  partition
ndrv=<partition>   Specifies the ndrv...sfs  partition
xdrv=<partition>   Specifies the xdrv...sfs  partition
...
bdrv=<partition>:<path>/<filename>   Specifies the bdrv...sfs file.
gdrv=<partition>:<path>/<filename>   Specifies the gdrv...sfs file.
ndrv=<partition>:<path>/<filename>   Specifies the ndrv...sfs file.
xdrv=<partition>:<path>/<filename>   Specifies the xdrv...sfs file.
